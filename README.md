...
2. Copiar el archivo PDF firmado electrónicamente en la ruta ```./app``` con el nombre ```signed.pdf```

3. Se debe construir el contenedor donde se ejecutará el llamado al API.
...
4. Ejecutar el siguiente comando:
    ...
    La respuesta será un JSON con la información del archivo firmado con la siguiente estructura:
    ```
    {
